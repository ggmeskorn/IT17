...
class GridViewPets extends StatefulWidget {
  _GridViewPetsState createState() => _GridViewPetsState();
}

class _GridViewPetsState extends State<GridViewPets> {
  List petsdata2 = List();
